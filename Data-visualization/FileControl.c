...
/*
* Function: Search_csv_and_print
* 功能: 搜寻当前目录下的csv文件，并按照规定的样式输出
* 参数: 无
* 返回值: 无
* 创建人: Zerokei
*/
...
static char filename[100]; /* filename: 记录打开的文件的名字*/
